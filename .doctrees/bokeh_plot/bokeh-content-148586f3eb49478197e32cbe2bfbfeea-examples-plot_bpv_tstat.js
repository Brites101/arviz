(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("0f6fccf8-1346-4281-bae5-b67a0ddaec83");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '0f6fccf8-1346-4281-bae5-b67a0ddaec83' but no matching script tag was found.")
        }
