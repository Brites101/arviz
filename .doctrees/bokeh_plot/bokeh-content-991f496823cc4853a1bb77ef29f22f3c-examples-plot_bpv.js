(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("e97eef83-7b16-4992-b976-43a832c8fcfa");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'e97eef83-7b16-4992-b976-43a832c8fcfa' but no matching script tag was found.")
        }
