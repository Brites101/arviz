(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("f114346e-efca-4e95-82ce-220fa4e1120e");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid 'f114346e-efca-4e95-82ce-220fa4e1120e' but no matching script tag was found.")
        }
