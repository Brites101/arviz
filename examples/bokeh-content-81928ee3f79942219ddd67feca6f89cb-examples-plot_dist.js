(function() {
  const fn = function() {
    ...
    (function(root) {
      ...
      const element = document.getElementById("6674a911-7c91-412b-935f-0ac1ddacb647");
        if (element == null) {
          console.warn("Bokeh: autoload.js configured with elementid '6674a911-7c91-412b-935f-0ac1ddacb647' but no matching script tag was found.")
        }
